...
async def create_comment(body: CommentCreateSchema, post_id: int,
                         ...
                         user: User = Depends(auth_security.get_current_user)) -> Comment:
...
async def get_comment(comment_id: int, user: User = Depends(auth_security.get_current_user),
...
async def delete_comment(comment_id: int, user: User = Depends(auth_security.get_current_user),
